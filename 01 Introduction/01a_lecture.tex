...
\begin{itemize}
\item
  The course is scheduled from Monday (22nd of January) to Friday (26th
  of January) from 2pm to 6pm Berlin time.
\item
...
\item
  ...
  (\url{https://github.com/jmsigner/movement_workshop_winter_2024})\footnote<.->{If
